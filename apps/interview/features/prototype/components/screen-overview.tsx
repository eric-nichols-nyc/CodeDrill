...
import {
  OVERVIEW_ANALYSIS_ENABLED,
  OverviewAnalysisAccordion,
} from "@/features/overview-analysis";
    ...
    <section className="mx-auto flex max-w-2xl flex-col gap-6 px-4 py-12">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          {OVERVIEW_ANALYSIS_ENABLED
            ? `Personalized for ${mockCandidateProfile.name} · ${mockInterview.company} · ${mockInterview.jobTitle}`
            : "Review your plan before you begin."}
        </p>
      </div>
      ...
      {OVERVIEW_ANALYSIS_ENABLED ? <OverviewAnalysisAccordion /> : null}
