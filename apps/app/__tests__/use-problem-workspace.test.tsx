...
import { useProblemWorkspace } from "@/features/problem-workspace/components/editor-panel/hooks/use-problem-workspace";

vi.mock(
  "@/features/problem-workspace/components/editor-panel/queries/use-workspace-code-query",
  () => ({
...
vi.mock(
  "@/features/problem-workspace/components/editor-panel/queries/use-save-workspace-code-mutation",
  () => ({
