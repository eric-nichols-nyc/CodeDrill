...
| `problem-workspace` (workspace refactor) | [11-workspace-refactor.md](./11-workspace-refactor.md) | `features/problem-workspace/{shell,directions-panel,editor-panel,output-panel,chat-panel}/` | None (UI layout only) | **In progress** — shell + provider + placeholder panels |
